...
func TestValidation(t *testing.T) {
	...
	for _, tc := range []testcase{
		...
		{
			name:   "(int) rejects literal decimal",
			schema: ks.Int(),
			value:  ks.LitDecimal("69.0"),
			want:   false,
		},
		{
			name:   "(real) accepts a float64 value",
			schema: ks.Real(),
			value:  ks.Where(ks.Float64(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			want:   true,
		},
		{
			name:   "(real) accepts a float32 value",
			schema: ks.Real(),
			value:  ks.Where(ks.Float32(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			want:   true,
		},
		{
			name:   "(real) compares a float64 value exactly",
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Ge, ks.DecimalExpr("0.1"))),
			value:  ks.Where(ks.Float64(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			want:   true,
		},
		{
			name:   "(real) equate float64 0.1 with exact decimal 0.1",
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			value:  ks.Where(ks.Float64(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			want:   true,
		},
		{
			name:   "float32 accepts an exact float32 value",
			schema: ks.Float32(),
			value:  ks.Where(ks.Float32(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			want:   true,
		},
		{
			name:   "float32 accepts a float64 value rounded by conversion",
			schema: ks.Float32(),
			value:  ks.Where(ks.Float64(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			want:   true,
		},
		{
			name:   "float32 rejects a value outside its finite range",
			schema: ks.Float32(),
			value:  ks.Where(ks.Float64(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("1e39"))),
			want:   false,
		},
		{
			name:   "float64 accepts a float64 value",
			schema: ks.Float64(),
			value:  ks.Where(ks.Float64(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			want:   true,
		},
		{
			name:   "float64 accepts a float32 value",
			schema: ks.Float64(),
			value:  ks.Where(ks.Float32(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1"))),
			want:   true,
		},
		{
			name:   "float64 rejects a value outside its finite range",
			schema: ks.Float64(),
			value:  ks.LitDecimal("1e309"),
			want:   false,
		},

		{
			name:   "(float) accepts integers converted to float",
			schema: ks.Float(),
			value:  ks.LitInt(int64(2<<53) + 0),
			want:   true,
		},
		{
			name:   "(float) accepts integers rounded during conversion",
			schema: ks.Float(),
		...
		},
		{
			...
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Gt, ks.DecimalExpr("0.1"))),
			value:  ks.LitDecimal("0.1"),
		},
		{
			name:   "(real): arbitrarily close value is accepted",
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Gt, ks.DecimalExpr("0.1"))),
			value:  ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Eq, ks.DecimalExpr("0.1000000000000000000000001"))),
			want:   true,
		},
		{
		...
		},
		{
			...
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Gt, ks.DecimalExpr("0.1"))),
			value:  ks.LitDecimal("0.099999999999999999999999999999999999999999999999999999999999999"),
			want:   false,
		},
		{
			name:   "(real): number inside of arbitrarily large constraint bound (edge)",
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Ge, ks.DecimalExpr("1234567890123456789012345678901234567890.00000000000000000001"))),
		...
		},
		{
			...
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Ge, ks.DecimalExpr("1234567890123456789012345678901234567890.00000000000000000001"))),
			value:  ks.LitDecimal("2e1000"),
			want:   true,
		},
		{
			name: "(real): check enum + bound using int",
			schema: ks.With(ks.Real(),
				ks.Check(ks.Binary(ks.X(), ks.Gt, ks.DecimalExpr("1"))),
				ks.Check(ks.Binary(ks.X(), ks.In, ks.ListExpr(ks.LitInt(1), ks.LitDecimal("2")))),
			),
			value: ks.LitInt(1),
			want:  false,
		},
		{
			...
			schema: ks.With(ks.Real(),
				ks.Check(ks.Binary(ks.X(), ks.Gt, ks.DecimalExpr("1"))),
				ks.Check(ks.Binary(ks.X(), ks.In, ks.ListExpr(ks.LitInt(1), ks.LitDecimal("2.0")))),
			),
			value: ks.LitDecimal("2"),
			want:  true,
		},
		{
		...
		},
		{
			...
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Ge, ks.DecimalExpr("0.1"))),
			value:  ks.LitDecimal("0.099999999999999999"),
		},
		{
			name:   "(real): < rejects the exact upper edge",
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Lt, ks.DecimalExpr("0.1"))),
			value:  ks.LitDecimal("0.1"),
		},
		{
		...
		},
		{
			...
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Le, ks.DecimalExpr("0.1"))),
			value:  ks.LitDecimal("0.1"),
			want:   true,
		},
		{
			...
			schema: ks.Where(ks.Real(), ks.Binary(ks.X(), ks.Le, ks.DecimalExpr("0.1"))),
			value:  ks.LitDecimal("0.100000000000000001"),
		},
		{
			name:   "(real): reversed lower comparison is normalized",
			schema: ks.Where(ks.Real(), ks.Binary(ks.DecimalExpr("0.1"), ks.Lt, ks.X())),
			value:  ks.LitDecimal("0.100000000000000001"),
			want:   true,
		},
		{
			name:   "(real): reversed upper comparison is normalized",
			schema: ks.Where(ks.Real(), ks.Binary(ks.DecimalExpr("0.1"), ks.Gt, ks.X())),
			value:  ks.LitDecimal("0.099999999999999999"),
			want:   true,
		},
		{
			...
			schema: ks.With(ks.Real(),
				ks.Check(ks.Binary(ks.X(), ks.Ge, ks.DecimalExpr("0.1"))),
				ks.Check(ks.Binary(ks.X(), ks.Ge, ks.DecimalExpr("0.2"))),
			),
			value: ks.LitDecimal("0.15"),
		},
		{
		...
		},
		{
			...
			schema: ks.With(ks.Real(),
				ks.Check(ks.Binary(ks.X(), ks.Le, ks.DecimalExpr("0.2"))),
				ks.Check(ks.Binary(ks.X(), ks.Le, ks.DecimalExpr("0.1"))),
			),
			value: ks.LitDecimal("0.15"),
		},
		{
		...
		},
		{
			...
			schema: ks.With(ks.Real(),
				ks.Check(ks.Binary(ks.X(), ks.Ge, ks.DecimalExpr("1"))),
				ks.Check(ks.Binary(ks.X(), ks.Gt, ks.DecimalExpr("1"))),
			),
			value: ks.LitDecimal("1"),
		},
		{
		...
		},
		{
			...
			schema: ks.With(ks.Real(),
				ks.Check(ks.Binary(ks.X(), ks.Le, ks.DecimalExpr("1"))),
				ks.Check(ks.Binary(ks.X(), ks.Lt, ks.DecimalExpr("1"))),
			),
			value: ks.LitDecimal("1"),
		},
		{
